...
type Lang = 'zh' | 'en';
const TEXTS = { zh: { brand: '瀚森金屬工程有限公司', nav:{services:'服務項目',projects:'代表實績',about:'關於我們',contact:'聯絡我們'}, hero:{title:'金屬外牆．玻璃帷幕．鋁包板', subtitle:'十年以上大型商辦與科技廠房經驗｜準時品質、專業承諾', cta:'聯絡我們'}, services:{title:'服務項目', items:[{name:'玻璃帷幕',desc:'根據建築外觀及設計需求，選擇最適合的帷幕牆系統與玻璃配置，確保性能及美學兼具'},{name:'鋁板/金屬包板',desc:'兼具設計美學及經濟效益，提供耐久性及穩定外觀的方案'},{name:'不鏽鋼/金屬格柵',desc:'綜合建築機能及設計需求，評估遮陽、通風效果，並選擇合適材質及形式'},{name:'結構補強/整修',desc:'透過專業檢測掌握舊樓外牆問題，量身打造翻新及補強措施'}]}, projects:'代表實績', about:{title:'關於我們',text:'瀚森金屬工程專精於金屬外牆與玻璃帷幕工程，從細部設計、材料選型到現場安裝，提供一站式服務。以「準時交付、專業承諾」為核心價值。', bullets:['台元九期、遠百 A13、華南土城 等大型專案經驗','提供外牆規劃、大樣設計、結構評估','鋁擠型、金屬板、玻璃、石材、不鏽鋼材料設計及評估','現場施工管理與品質控管，準時交付']}, contact:{title:'聯絡我們',address:'桃園市中壢區中山東路三段160號',email:'hsmetal060825@gmail.com',phone:'0985321566',lineId:'wenkai987',lineBtn:'加 Line 諮詢',lineQr:'/images/line-qr.jpg'} }, en:{brand:'HS Metal Co., Ltd.',nav:{services:'Services',projects:'Projects',about:'About',contact:'Contact'}, hero:{title:'Metal Façade · Glass Curtain Wall · Aluminum Cladding', subtitle:'10+ years in office towers & science parks | On-time quality, professional commitment', cta:'Contact'}, services:{title:'Services', items:[{name:'Glass Curtain Wall',desc:'Choose the right system and glazing to balance performance and aesthetics'},{name:'Aluminum / Metal Cladding',desc:'Durable solutions with consistent appearance and cost-effectiveness'},{name:'Stainless / Grilles',desc:'Evaluate shading and ventilation, choose proper material & form'},{name:'Retrofit / Reinforcement',desc:'Inspect façade issues and tailor renovation & reinforcement'}]}, projects:'Projects', about:{title:'About',text:'We focus on metal façades and glass curtain walls.', bullets:['Experience in major office & retail projects','Façade planning, detail design and structural study','Design & evaluation of aluminum, glazing, stone & stainless','On-site management & quality control']}, contact:{title:'Contact',address:'No.160, Sec.3, Zhongshan E. Rd., Taoyuan',email:'hsmetal060825@gmail.com',phone:'+886 985 321 566',lineId:'wenkai987',lineBtn:'Chat on Line',lineQr:'/images/line-qr.jpg'} } } as const;
const PROJECTS = [
...
const SIcon = ({ d }: { d: string }) => (<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className='h-7 w-7' style={{fill:'none',stroke:BRAND_GOLD,strokeWidth:1.8}}><path d={d} strokeLinecap='round' strokeLinejoin='round' /></svg>);
...
export default function HsMetalLanding() {
  ...
  const t = TEXTS[lang];
  useEffect(()=>{ console.assert(PROJECTS.length===4,'[TEST] 4 projects'); },[]);
  return (
    <main className="min-h-screen bg-white text-slate-800">
      ...
      <section className="border-b border-slate-200 bg-[url('/images/taiyen.jpg')] bg-cover bg-center">
        <div className="mx-auto max-w-7xl px-4 py-16 md:py-24 bg-black/30 text-white">
          <h1 className="text-3xl font-bold md:text-5xl drop-shadow">{t.hero.title}</h1>
