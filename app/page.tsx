...
const TEXTS = {
  zh: {
    ...
    projects:'代表實績',
    about:{title:'關於我們',text:'瀚森金屬工程專精於金屬外牆與玻璃帷幕工程，從細部設計、材料選型到現場安裝，提供一站式服務。以「準時交付、專業承諾」為核心價值，累積多年大型專案經驗，代表實績涵蓋商辦、百貨、金融與科技廠辦。',bullets:[
  ...
  en: {
    ...
    projects:'Projects',
    about:{title:'About',text:'HS Metal specializes in metal façades and glass curtain walls, delivering one-stop service from detail design and material selection to on-site installation. With “On-time Delivery, Professional Commitment” as our core value, we have extensive experience in major projects across office towers, retail, finance, and science park facilities.',bullets:[
